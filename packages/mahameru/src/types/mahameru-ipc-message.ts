...
export type MahameruIPCMessageChild<
  K extends MahameruIPCChildMessageTypes = MahameruIPCChildMessageTypes,
> = {
  [P in K]: {
    type: P;
...
export type MahameruIPCMessageServer<
  K extends MahameruIPCServerMessageTypes = MahameruIPCServerMessageTypes,
> = {
  [P in K]: {
    type: P;
